"""
Pipeline для обработки данных и обучения модели классификации цен автомобилей.
Сравнивает разные модели и сохраняет лучшую.
"""
...
def pipeline() -> None:
    ...
    print(f"Reading file from: {os.path.join(path, 'data', 'train', 'homework.csv')}")
