...
import bitrix_downloader

PROJECT_PATH = Path(bitrix_downloader.__file__).parent.parent.resolve()
...
def make_alembic_config(
    ...
    if not os.path.isabs(cmd_opts.config):
        cmd_opts.config = str(
            base_path / "bitrix_downloader/infrastructure/database" / cmd_opts.config
        )
